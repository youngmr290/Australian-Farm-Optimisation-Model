...
#carryover credit 
model.carryover_credit = Var(model.s_cashflow_periods, bounds = (0.0, None), doc = 'amount of net positive cashflow brought into each year')
#carryover debit
model.carryover_debit = Var(model.s_cashflow_periods, bounds = (0.0, None), doc = 'amount of net negitive cashflow brought into each year')
##dep
