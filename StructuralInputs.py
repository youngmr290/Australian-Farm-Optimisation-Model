...
def structural_inp_sa():
    ...
    structuralsa['i_fvp_mask_offs'] = fun.f_sa(structuralsa_inp['i_fvp_mask_offs'], sen.sav['mask_fvp_offs'],5).astype(bool)
    structuralsa['i_dvp_mask_f3'] = fun.f_sa(structuralsa_inp['i_dvp_mask_f3'], sen.sav['fvp_is_dvp_offs'],5).astype(bool)
