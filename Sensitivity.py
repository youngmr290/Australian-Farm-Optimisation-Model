...
def create_sa():
    ...
    sav['period_is_reportffcfw_p'] = np.full(500, '-', dtype=object)  #todo remove after ewelamb analysis
    sav['LTW_loops'] = '-'                  #SA to control the number of ltw loops. Default is 1 (ie ltw adjustment not included).
