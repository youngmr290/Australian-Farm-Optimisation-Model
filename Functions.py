...
def xl_all_named_ranges(filename, targetsheets, rangename=None,numpy=False):     # read all range names defined in the list targetsheets and return a dictionary of lists or dataframes
