...
def f_run_report(lp_vars, r_vals, report_run, trial_name, infeasible = None, user_controls={}):
    ...
    if report_run.loc['run_feedbudget', 'Run']:
        ...
        residue_cols = f_update_default_controls(user_controls, 'feed', 'residue_cols', [7]) #biomass use
    ...
    if report_run.loc['run_feedbudget', 'Run']:
        ...
        residue_cols = f_update_default_controls(user_controls, 'feed_total', 'residue_cols', [7]) #biomass use
