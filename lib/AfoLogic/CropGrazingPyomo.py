...
def f1_cropgrazepyomo_local(params,model):
    ...
    model.p_cropgrazing_can_occur_klz = pe.Param(model.s_crops, model.s_lmus, model.s_season_types,
                                     initialize=params['propn_area_grazed_klz'], default=0, mutable=False,
