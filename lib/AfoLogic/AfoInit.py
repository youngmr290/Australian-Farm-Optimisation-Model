...
def exp(solver_method, user_data, property, trial_name, trial_description, sinp_defaults, uinp_defaults, pinp_defaults
    ...
    ###Return if this a calibration trial
    if calibration is not None:
        return 0, 0, 0, 0, 0, 0, d_rot_info   #is d_rotn_info required at this level?
    ...
    crtmod.sets(model, nv, params) #certain sets have to be updated each iteration of exp - has to be first since other modules use the sets
