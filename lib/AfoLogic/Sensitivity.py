...
def create_sa():
    ...
    sav['bnd_biomass_graze'] = np.full(len_k, '-', dtype=object)  #biomass graze area for bound. if all values are '-' the bnd won't be used (there is not bnd_inc control for this one)
