...
def f_phase_link_params(params):
    ...
    Phases from p7_prev don't transfer in the p7 period immediately preceding the break of season
    ...
    Note: a2 phases don't provide a history. This is required to stop pnc being selected all growing season
