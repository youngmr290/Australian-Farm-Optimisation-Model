...
def f1_stock_fs(cr_sire,cr_dams,cr_offs,cu0_sire,cu0_dams,cu0_offs,a_p6_pa1e1b1nwzida0e0b0xyg,
    ...
    #todo after Triplets uncomment the above line and delete the line of code below (code below makes all periods use the aStd feedsupply adjustment)
    ...
    #todo Change back after the Triplets analysis.
