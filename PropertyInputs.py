...
sheep_inp['i_sai_lw_dams_owi'] = np.full(ioW1, True) #this is acted on by SA but didn't need to be an inputs so it is added here. This controls if a nutrition pattern is included.
sheep_inp['i_sai_lw_offs_swix'] = np.full(isxW1, True) #this is acted on by SA but didn't need to be an inputs so it is added here. This controls if a nutrition pattern is included.
...
def property_inp_sa():
    ...
    sheep['i_nut_spread_n1'] = fun.f_sa(sheep_inp['i_nut_spread_n1'], sen.sav['nut_spread_n1'],5)
