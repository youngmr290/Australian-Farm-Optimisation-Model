...
def stubpyomo_local(params):
    ...
    try:
        ...
        pass
    model.p_stub_md = pe.Param(model.s_feed_periods, model.s_crops, model.s_stub_cat, initialize=params[season]['md'], default = 0.0, doc='md from 1t of each stubble categories for each crop')
    ...
    try:
        ...
        pass
    model.p_stub_vol = pe.Param(model.s_feed_periods, model.s_crops, model.s_stub_cat, initialize=params[season]['vol'], default = 0.0, doc='amount of intake volume required by 1t of each stubble category for each crop')
    ...
    try:
        ...
        pass
    model.p_a_req = pe.Param(model.s_feed_periods, model.s_crops, model.s_stub_cat, initialize=params[season]['cat_a_st_req'], default = 0.0, doc='stubble required in each feed periods in order to consume 1t of cat A')
