...
def universal_inp_sa():
    ...
    parameters['i_sfd_c2'] = fun.f_sa(parameters_inp['i_sfd_c2'].astype(float),sen.sam['sfd_c2'])
    ...
    parameters['i_swr_c2'] = fun.f_sa(parameters_inp['i_srw_c2'].astype(float), sen.sav['srw_c2'], 5) #genotype srw
