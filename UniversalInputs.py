...
def universal_inp_sa():
    ...
    ###SAA
    sheep['i_husb_operations_contract_cost_h2'] = fun.f_sa(sheep_inp['i_husb_operations_contract_cost_h2'],sen.saa['husb_cost'], 2)
    sheep['i_husb_operations_labourreq_l2h2'] = fun.f_sa(sheep_inp['i_husb_operations_labourreq_l2h2'],sen.saa['husb_labour'], 2)
    ###SAT
