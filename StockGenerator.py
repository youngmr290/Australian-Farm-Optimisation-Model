...
def generator(params,r_vals,ev,plots = False):
    ...
    o_ffcfw_prejoin_pdams = np.zeros(pg1, dtype =dtype)
    ...
    ##mask out any that occur before weaning
    mask = fvp_date_start_fa1e1b1nwzida0e0b0xyg1 <= date_weaned_ida0e0b0xyg1
    fvp_date_start_fa1e1b1nwzida0e0b0xyg1[mask] = date_start_p[0]
    fvp_type_fa1e1b1nwzida0e0b0xyg1[mask] = condense_vtype1
    ...
    shape = np.maximum.reduce([fvp_b0_start_ba1e1b1nwzida0e0b0xyg3.shape[1:], fvp_b1_start_ba1e1b1nwzida0e0b0xyg3.shape[1:], fvp_b2_start_ba1e1b1nwzida0e0b0xyg3.shape[1:]
                               ,seasonstart_ya1e1b1nwzida0e0b0xyg3.shape[1:], fvp_0_start_oa1e1b1nwzida0e0b0xyg3.shape[1:], fvp_1_start_oa1e1b1nwzida0e0b0xyg3.shape[1:],
    ...
    ##mask out any that occur before weaning
    mask = fvp_start_fa1e1b1nwzida0e0b0xyg3 <= date_weaned_ida0e0b0xyg3
    fvp_start_fa1e1b1nwzida0e0b0xyg3[mask] = offs_date_start_p[0]
    fvp_type_fa1e1b1nwzida0e0b0xyg3[mask] = condense_vtype3
    ...
    pasture_stage_pa1e1b1j0wzida0e0b0xyg = np.take_along_axis(pasture_stage_p6a1e1b1j0wzida0e0b0xyg, a_p6_untreatedz_pa1e1b1nwzida0e0b0xyg, 0) #this has untreated z axis, f_seasonal_inp is applied in the foo convert function
    ##mating
    ...
    ##set default numbers to initial numbers. So that p0 (dvp0 has numbers) and so that dvps that occur before weaning still transfer animals.
    o_numbers_start_pdams[...] =  numbers_initial_a1e1b1nwzida0e0b0xyg1  # default 1 so that dvp0 (p0) has start numbers
    o_numbers_end_pdams[...] = numbers_initial_a1e1b1nwzida0e0b0xyg1  # default 1 so that transfer can exist for dvps before weaning
    o_numbers_start_poffs[...] = numbers_initial_zida0e0b0xyg3 # ones so that dvp0 (p0) has start numbers.
    o_numbers_end_poffs[...] = numbers_initial_zida0e0b0xyg3 #ones so that transfer can exist for dvps before weaning
    ...
    for loop_ltw in range(2):
        ...
        ##offs
            ...
            for itn in range(n_max_itn):
                ...
                if np.any(days_period_pa1e1b1nwzida0e0b0xyg0[p,...] >0):
                    foo_sire, hf_sire, dmd_sire, intake_s_sire, md_herb_sire = sfun.f_feedsupply(cu3, cu4, cr_sire, feedsupply_std_pa1e1b1nwzida0e0b0xyg0[p], paststd_foo_pa1e1b1j0wzida0e0b0xyg[p], paststd_dmd_pa1e1b1j0wzida0e0b0xyg[p], legume_pa1e1b1nwzida0e0b0xyg[p], pi_sire, pasture_stage_pa1e1b1j0wzida0e0b0xyg[p])
                if np.any(days_period_pa1e1b1nwzida0e0b0xyg1[p,...] >0):
                    foo_dams, hf_dams, dmd_dams, intake_s_dams, md_herb_dams = sfun.f_feedsupply(cu3, cu4, cr_dams, feedsupplyw_pa1e1b1nwzida0e0b0xyg1[p], paststd_foo_pa1e1b1j0wzida0e0b0xyg[p], paststd_dmd_pa1e1b1j0wzida0e0b0xyg[p], legume_pa1e1b1nwzida0e0b0xyg[p], pi_dams, pasture_stage_pa1e1b1j0wzida0e0b0xyg[p])
                if np.any(days_period_pa1e1b1nwzida0e0b0xyg3[p,...] >0):
                    foo_offs, hf_offs, dmd_offs, intake_s_offs, md_herb_offs = sfun.f_feedsupply(cu3, cu4, cr_offs, feedsupplyw_pa1e1b1nwzida0e0b0xyg3[p], paststd_foo_pa1e1b1j0wzida0e0b0xyg[p], paststd_dmd_pa1e1b1j0wzida0e0b0xyg[p], legume_pa1e1b1nwzida0e0b0xyg[p], pi_offs, pasture_stage_pa1e1b1j0wzida0e0b0xyg[p])
        ...
        ###dams
            ...
            o_numbers_start_pyatf[p] = numbers_start_yatf #used for npw calculation - use numbers start because weaning is start of period - has to be out of the 'if' because there is 0 days in the period when weaning occurs but we still want to store the start numbers
        ...
        ###offs
            if np.any(days_period_pa1e1b1nwzida0e0b0xyg3[p,...] >0):
                ...
                o_ffcfw_season_poffs[p] = sfun.f_season_wa(numbers_end_offs, ffcfw_offs, season_tup, idx_min_lw_z_offs, period_is_startseason_pa1e1b1nwzida0e0b0xyg[p+1])
            ...
            if np.any(days_period_pa1e1b1nwzida0e0b0xyg0[p,...] >0):
                ...
                omer_history_start_m3g0 = sfun.f_period_start_prod(numbers_end_sire, omer_history_sire, prejoin_tup, season_tup, sinp.stock['i_n0_len']
                                        , sinp.stock['i_w0_len'], sinp.stock['i_n_fvp_period0'], numbers_start_condense_sire
                                        , False, period_is_startseason_pa1e1b1nwzida0e0b0xyg[p+1], idx_min_lw_z_sire[na,...])  #increment the p slice, note this doesnt impact the p loop - this is required for the next section because we are calculating the production and numbers for the start of the next period.
            ...
            if np.any(days_period_pa1e1b1nwzida0e0b0xyg1[p,...] >0):
                ...
                omer_history_start_m3g1 = sfun.f_period_start_prod(numbers_end_dams, omer_history_dams, prejoin_tup, season_tup, n_fs_dams
                                            , len_w1, n_fvp_periods_dams, numbers_start_condense_dams
                                            , period_is_condense_pa1e1b1nwzida0e0b0xyg1[p+1], period_is_startseason_pa1e1b1nwzida0e0b0xyg[p+1]
                                            , idx_min_lw_z_dams[na,...], period_is_prejoin_pa1e1b1nwzida0e0b0xyg1[p+1], group=1)
                ###Clean fleece weight (start)
            ...
            if np.any(days_period_pa1e1b1nwzida0e0b0xyg3[p,...] >0):
                ...
                ffcfw_start_offs = sfun.f_period_start_prod(numbers_end_offs, ffcfw_offs, prejoin_tup, season_tup, n_fs_offs
                                    ...
                                    , period_is_condense_pa1e1b1nwzida0e0b0xyg3[p+1], period_is_startseason_pa1e1b1nwzida0e0b0xyg[p+1], idx_min_lw_z_offs)
                ###normal weight	- yes this is meant to be updated from nw_start
                ...
                omer_history_start_m3g3 = sfun.f_period_start_prod(numbers_end_offs, omer_history_offs, prejoin_tup, season_tup, n_fs_offs
                                            , len_w3, n_fvp_periods_offs, numbers_start_condense_offs
                                            , period_is_condense_pa1e1b1nwzida0e0b0xyg3[p+1], period_is_startseason_pa1e1b1nwzida0e0b0xyg[p+1], idx_min_lw_z_offs[na,...])
                ###Clean fleece weight (start)
    ...
    ####mask out any that occur before weaning
    mask = dvp_date_va1e1b1nwzida0e0b0xyg1 <= date_weaned_ida0e0b0xyg1
    dvp_date_va1e1b1nwzida0e0b0xyg1[mask] = date_start_p[0]
    ...
    ####mask out any that occur before weaning
    mask = dvp_date_va1e1b1nwzida0e0b0xyg3 <= date_weaned_ida0e0b0xyg3
    dvp_date_va1e1b1nwzida0e0b0xyg3[mask] = offs_date_start_p[0]
    ...
    ffcfw_dest_condense_tva1e1b1nwzida0e0b0xyg1 = sfun.f_p2v(o_ffcfw_condensed_pdams, a_v_pa1e1b1nwzida0e0b0xyg1, period_is_tp=nextperiod_is_condense_pa1e1b1nwzida0e0b0xyg1)  #numbers not required for ffcfw
    ###offs
    ...
    distribution_condense_va1e1b1nw8zida0e0b0xyg1w9 = sfun.f_lw_distribution(ffcfw_dest_condense_tva1e1b1nwzida0e0b0xyg1, ffcfw_source_condense_va1e1b1nwzida0e0b0xyg1,
                                                                     n_fs_dams, n_fvp_periods_dams, dvp_type_next_va1e1b1nwzida0e0b0xyg1[...,na],
                                                                     condense_vtype1)
    ...
    distribution_prejoin_tva1e1b1nw8zida0e0b0xyg1w9 = sfun.f_lw_distribution(ffcfw_dest_condense_tva1e1b1nwzida0e0b0xyg1, ffcfw_source_prejoin_tva1e1b1nwzida0e0b0xyg1,
    ...
    keys_v3 = np.array(['dvp%02d'%i for i in range(dvp_date_va1e1b1nwzida0e0b0xyg3.shape[0])])
