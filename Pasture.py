...
#    germination_flrzt           = np.zeros(flrzt,  dtype = 'float64')  # germination for each rotation phase (kg/ha)
    ...
    germination_flrzt, max_germination_flz, resown_rt = pfun.f_germination(i_germination_std_zt, i_germ_scalar_lzt
                                                                , i_germ_scalar_fzt, pasture_rt, arable_l
    ...
    foo_grn_reseeding_flrzt, foo_dry_reseeding_dflrzt, periods_destocked_fzt = pfun.f_reseeding(
        ...
        , i_restock_fooscalar_lt, i_restock_foo_arable_t, dry_decay_period_fzt, i_fxg_foo_oflzt, c_fxg_a_oflzt
        , c_fxg_b_oflzt, i_grn_senesce_eos_fzt, grn_senesce_startfoo_fzt, grn_senesce_pgrcons_fzt, max_germination_flz
